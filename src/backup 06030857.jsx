    ...
    <div className="font-sans text-black bg-white min-h-screen selection:bg-black selection:text-white antialiased overflow-x-hidden">
     ...
     {/* Wat mag je verwachten? (Videos) */}
      <section id="media" className="py-24 bg-white overflow-hidden">
        ...
        {/* Carousel Layout: 10vw padding + 80vw video = Perfectly centered on mobile */}
        <div className="flex gap-4 md:gap-6 overflow-x-auto px-[10vw] md:px-6 md:justify-center pb-12 pt-4 snap-x snap-mandatory scroll-smooth hide-scrollbar">
          {reels.map((item, i) => (
      ...
      <section id="contact" className="py-24 bg-gray-50 px-6 border-t border-black/10">
        <div className="max-w-4xl mx-auto">
          ...
          <form 
            ...
            method="POST" 
            className="bg-white p-5 md:p-12 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] flex flex-col gap-6 max-w-full overflow-hidden"
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2 min-w-0">
                ...
                <input required type="text" name="Contactgegevens" className="w-full p-4 border-2 border-black focus:outline-none focus:bg-gray-50 transition-colors" placeholder="Hoe kunnen we je bereiken?" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2 min-w-0">
                ...
                <select required name="Aantal Personen" className="w-full p-4 border-2 border-black focus:outline-none focus:bg-gray-50 transition-colors bg-white">
